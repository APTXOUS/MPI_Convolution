...
unsigned char getValue(int ii, unsigned char *arrary)
{
    ...
    // }
    vv += ii;
    sum += arrary[vv - 2] * GsCore[4][4];
    sum += arrary[vv - 1] * GsCore[4][3];
    sum += arrary[vv] * GsCore[4][2];
    sum += arrary[vv + 1] * GsCore[4][1];
    sum += arrary[vv + 2] * GsCore[4][0];
    vv += Value;
    sum += arrary[vv - 2] * GsCore[3][4];
    sum += arrary[vv - 1] * GsCore[3][3];
    sum += arrary[vv] * GsCore[3][2];
    sum += arrary[vv + 1] * GsCore[3][1];
    sum += arrary[vv + 2] * GsCore[3][0];

    vv += Value;
    sum += arrary[vv - 2] * GsCore[2][4];
    sum += arrary[vv - 1] * GsCore[2][3];
    sum += arrary[vv] * GsCore[2][2];
    sum += arrary[vv + 1] * GsCore[2][1];
    sum += arrary[vv + 2] * GsCore[2][0];

    vv += Value;
    sum += arrary[vv - 2] * GsCore[1][4];
    sum += arrary[vv - 1] * GsCore[1][3];
    sum += arrary[vv] * GsCore[1][2];
    sum += arrary[vv + 1] * GsCore[1][1];
    sum += arrary[vv + 2] * GsCore[1][0];

    vv += Value;
    sum += arrary[vv - 2] * GsCore[0][4];
    sum += arrary[vv - 1] * GsCore[0][3];
    sum += arrary[vv] * GsCore[0][2];
    sum += arrary[vv + 1] * GsCore[0][1];
    sum += arrary[vv + 2] * GsCore[0][0];
    return sum;
}
